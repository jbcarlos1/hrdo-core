...
import { PackageOpen, Archive, Package } from "lucide-react";
import {
    Select,
    SelectTrigger,
    SelectContent,
...
import { TableComponent } from "./supply-out-table";
import useDebounce from "@/hooks/useDebounce";
import { CartProvider } from "@/contexts/cart-context";
import { Cart } from "./cart";
import { LuLayoutGrid, LuTable2 } from "react-icons/lu";
import CardView from "@/components/crud/supply-out-card-view";
...
export default function SupplyOutDashboard() {
                ...
                <AlertDialogContent className="max-w-[500px] p-0 overflow-hidden">
                    ...
                    <div className="p-6">
                        <AlertDialogDescription className="text-center text-base leading-relaxed text-gray-600 dark:text-gray-300">
                            This is the place where you can request supplies to
                            fulfill your office needs. Browse the available
                            items, select what you require, and submit your
                    ...
                    <AlertDialogFooter className="px-6 py-4 bg-gray-50 dark:bg-gray-800/50">
                        <AlertDialogAction
                            ...
                            className="w-full bg-gradient-to-r from-[#700f11] to-[#9a1518] hover:from-[#5a0c0e] hover:to-[#801114] text-white font-medium py-2 px-6 rounded-lg transition-all duration-200 transform hover:scale-[1.02]"
                        >
                            Get Started
                        </AlertDialogAction>
                    </AlertDialogFooter>
